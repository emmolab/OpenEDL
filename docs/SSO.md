...
- Configure a temporary, strong `ADMIN_TOKEN` and enter it on the OpenEDL
  sign-in screen.
- During localhost-only development, use the development administrator when no
  users or providers exist.
